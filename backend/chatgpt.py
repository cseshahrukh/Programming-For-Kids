...
def fillValues(question, code, count):
    ...
    messages=[
            ...
            change. You only give a hint how they might correct it. You give hints based on a scale from 1 to 3. 1 on the scale \
             ...
             mentioned and 3 means you point out the explicit change in the code. Currently, you are on {count} in the scale. Give \
             only the hint corresponding to where you are on the scale. Be as concise as you can."},
...
response = fillValues(question, code, 3)
